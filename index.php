...
add_action( 'init' , function(){
	...
	add_filter( 'kirki_control_types', function ( $controls ) {
			...
			$controls['simple-gradient'] = 'KIRKI_SIMPLE_GRADIENT';
			return $controls;
...
add_action( 'customize_register', 'kirki_simple_gradient_customize_register' );
function kirki_simple_gradient_customize_register(){

	class KIRKI_SIMPLE_GRADIENT extends Kirki_Control_Base {
		...
		public function enqueue() {
			...
			wp_enqueue_script( 
				'kirki-simple-gradient-js', 
				plugin_dir_url( __FILE__ ) . 'js/scripts.js', 
				array( 'jquery' )
			);
			wp_enqueue_style( 
				'kirki-simple-gradient-css', 
		...
		public function render_content() {
			...
			$filtered_data = ksg_get_defaults_in_array( $default );
...
function ksg_get_defaults_in_array( $default ){
